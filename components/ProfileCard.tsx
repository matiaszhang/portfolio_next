  ...
  return (
    <div className="profile h-full lg:w-[42rem] xl:w-[48rem] bg-gray-900 rounded-lg relative lg:block hidden">
      <div className="relative z-40 w-full h-full myShadow">
        ...
        <h1 className="text-center text-gray-300 text-[3.4rem] font-medium mt-4 mb-0.5">{profileData.name}</h1>

        <Typing />
        <MediaIcons />

        <div className="absolute bottom-0 left-0 flex w-full h-28 borderLeft customLine">
          <MyLink name="download cv" Icon={BsFillCloudArrowDownFill} url={`https://drive.google.com/file/d/12G17oIzW1LVRUferu3_pQRTuMUhtABZd/view`} border />
          <MyLink name="my linkedin" Icon={AiFillLinkedin} url="https://www.linkedin.com/in/matias-zhang-842b95291/" />
        </div>
      </div>
    </div>
  );
