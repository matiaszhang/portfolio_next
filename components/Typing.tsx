  ...
  return (
    <div className="text-center h-8">
      <Typewriter
        onInit={(typewriter) => {
          typewriter
            .typeString('<span style="color: #f59e0b; font-size: 14px; font-weight: 400;">Mobile Engineer</span>')
            .pauseFor(3500)
            .deleteAll(17)
            ...
            .typeString('<span style="color: #f59e0b; font-size: 14px; font-weight: 400;">Blockchain Engineer</span>')
            .pauseFor(3500)
            .deleteAll(17)
